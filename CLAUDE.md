...
- Scripts run through `tsx`; prefer existing npm scripts when present, especially `npm run seo:audit`, `npm run content:promote`, and `npm run content:generate-comparisons`.
