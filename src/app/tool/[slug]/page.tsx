      ...
      <div className="flex flex-col gap-12 lg:flex-row">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-2.5">
            ...
            {tool.githubStars && (
              <a href={tool.githubUrl ?? "#"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-full border border-[var(--color-border)] bg-white px-3 py-1 text-sm font-medium text-[var(--color-ink-muted)] transition-all hover:border-[var(--color-ink)]/20 hover:shadow-sm">
